...
export default {
    ...
    methods: {
        ...mapMutations({
            ...
            clearGroups: "projects/clearGroups",
            clearProjects: "projects/clearProjects",
        }),

        ...mapActions({
            getGroupTypes: "projects/getGroupTypes",
            createGroupS: "projects/createGroup",
            updateGroupS: "projects/updateGroup",
            postSocLink: "projects/postSocialLink",
        ...
        async initUpdate() {
            ...
            if(formData.workgroup_logo) {
                formData.workgroup_logo = formData.workgroup_logo
            }
        ...
        getValidUrl(url = "") {
            ...
            if (RegExp.test(url)) {
                ...
                this.$messgae.error(this.$t('project.invalid_link'))
            }
        },
