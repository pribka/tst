<template>
    <div ref="groupLightWrap">
        ...
        <a-card
            v-if="isStudent"
            :title="isMobile ? false : $t('project.gallery')"
            size="small"
            class="lg:mt-base"
            ...
            <div 
                ...
                <a-empty :description="$t('project.image_not_found')" />
            </div>
            <a-button
                v-if="isFounder"
                type="dashed"
            ...
            <div >
                ...
                <swiper
                    ...
                    <swiper-slide
                        ...
                        <a-popconfirm :title="$t('project.delete_image')+'?'"
                                      :ok-text="$t('project.yes')"  @confirm="deleteImageInGalery(item)" 
                                      :cancel-text="$t('project.no')">
                            <a-button
                                v-if="isFounder"
                                type="danger"
                                icon="close"
        ...
        <!-- Загрузить галерею -->
        <a-modal 
            :title="$t('project.add_image')" 
            :zIndex="1010"
            :cancelText="$t('project.cancel')"
            :okText="$t('project.upload_file')" 
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            postGalery: "projects/postImageGalery",
            getGaleryS: "projects/getGalery",
            deleteImageGalery: "projects/deleteImageGalery",
