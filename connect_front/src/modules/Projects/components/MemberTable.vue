            ...
            <a-table
                ...
                <template slot="member" slot-scope="text, record">
                    <Profiler
                        ...
                        :subtitle="{ text: getMembershipRoleName(record), class: 'text-xs' }"
                        :user="record.member" />
                </template>
...
export default {
    ...
    data() {
        return {
            ...
            defaultColumns: [
                ...
                {
                    title: this.$t('table.email_employee'),
                    dataIndex: 'member.email',
                    key: "email",
                    width: 260,                    
                },
                {
                    title: this.$t('table.last_activity'),
    ...
    methods: {        
        ...
        getData() {
            ...
            return this.$store.dispatch('projects/setTable', actionPayload)
                .then(() => {
