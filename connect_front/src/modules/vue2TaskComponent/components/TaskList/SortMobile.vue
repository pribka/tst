...
export default {
    ...
    data() {
        return {
            ...
            sortedItems: [
                {   
                    name: this.$t('task.mobile_sort.descendingOrder'),
                    param: '-counter',
                    icon: 'fi-rr-arrow-down'
                },
                {   
                    name: this.$t('task.mobile_sort.ascendingOrder'),
                    param: 'counter',
                    icon: 'fi-rr-arrow-up'
                },
                {   
                    name: this.$t('task.mobile_sort.byOperator'),
                    param: 'operator',
        ...
        active() {
            if(this.activeSort?.length) {
                ...
                if(find)
                    ...
                    return {
                        name: this.$t('task.mobile_sort.newItems'),
                        param: '-created_at',
