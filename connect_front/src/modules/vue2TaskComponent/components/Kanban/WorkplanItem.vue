<template>
    <div :class="mainClass">
        <a-card
            ...
            class="kanban-card">
            <div class="card_title flex items-start justify-between truncate mb-1">
                <div class="flex truncate">
                    <span
                        v-if="item.priority === 3"
                        class="priority">
                        <a-tooltip destroyTooltipOnHide :title="$t('task.large_priority')">
                    ...
                    <span
                        ...
                        class="priority">
                        <a-tooltip destroyTooltipOnHide :title="$t('task.very_large_priority')">
                    ...
                    <span
                        ...
                        class="priority">
                        <a-tooltip destroyTooltipOnHide :title="$t('task.very_low_priority')">
