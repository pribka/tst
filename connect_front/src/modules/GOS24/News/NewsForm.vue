    ...
    <a-form-model ref="formRef" class="task_form_wrap" :model="form" :rules="rules">
        ...
        <a-tabs size="large" animated>
            <a-tab-pane key="ru-title" tab="Заголовок (ru)">
                <a-form-model-item :rules="formInfo.title.rules" :label="'Заголовок (ru)'" prop="title">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <a-form-model-item :rules="rules.publication_date" :label="formInfo.publication_date.title" prop="publication_date">
                <DatePicker
            ...
            <a-form-model-item label="Раздел" :rules="formInfo.partition.rules" prop="partition">
                <DrawerSelectPartition v-model="form.partition" />
            </a-form-model-item>
        </div>

        <a-form-model-item label="Теги" :rules="formInfo.tags.rules" prop="tags">
        ...
        <a-tabs size="large" animated>
            <a-tab-pane key="ru-body" tab="Содержание (ru)">
                <a-form-model-item label="Содержание (ru)" :rules="formInfo.body.rules" prop="body">
                    <component
        ...
        <a-tabs size="large" animated>
            <a-tab-pane key="ru-desc" :tab="`Описание (ru: ${descriptionLengthRu})`">
                <a-form-model-item :label="`Описание (ru: ${descriptionLengthRu})`" :rules="formInfo.description.rules" prop="description">
                    <component
                        :showTextDecorations="true"
                        :uploadFieldKey="uploadFieldKey"
                        :uploadUrl="uploadUrl"
            ...
            <a-tab-pane key="kk-desc" :tab="`Описание (kk: ${descriptionLengthKk})`">
                <a-form-model-item :label="`Описание (kk: ${descriptionLengthKk})`" prop="description_kk">
                    <component
                        :showTextDecorations="true"
                        :uploadFieldKey="uploadFieldKey"
                        :uploadUrl="uploadUrl"
