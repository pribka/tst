<template>
    <a-popover
        ...
        <div v-if="inputType === 'input'" class="ant-input ant-input-ghost select-none cursor-pointer" :title="valueTitle">
        ...
        <template #content>
            ...
            <div class="popover_list">
                <template v-if="candidates && candidates?.length">
                    <div class="block_title px-2 mt-1">
                        Предлагаю
                    </div>
                    <div
                    ...
                    <div class="block_title px-2 mt-2 mb-1">
                        Весь список
                    </div>
                </template>
                <div
            ...
            <div v-if="inputType === 'avatar' && hasValue && showClear" class="pt-1 mb-1">
