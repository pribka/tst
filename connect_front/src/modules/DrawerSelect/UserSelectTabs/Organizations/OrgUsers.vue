        ...
        <template v-if="multiple">
            <div class="multiple">
                ...
                <div class="list">
                    <UserItem 
                        v-for="user in list"
                        checkedClass="org-checked-class"
                        :key="user.id"
                        :multiple="multiple"
...
export default {
    ...
    methods: {
        selectAll() {
            if (!this.selectedOrgID || !this.list.length) return
            if (this.next) {
                this.pageSize = 'all'
        ...
        async getList($state = null) {
            ...
            if (!this.loading) {
                try {
                    ...
                    const { data } = await this.$http.get(`users/my_organizations/${this.selectedOrgID}/users_short/`, { params })
                    this.next = data.next
