<template>
    <div :class="[!buttonMode && !hide && 'user_draw_input ant-input relative flex items-center flex-wrap', inputClass, size, disabled && 'ant-input-disabled']">
                                ...
                                <div class="flex items-center">
                                    <div class="mr-1">
                                        <a-avatar 
                                            ...
                                            :size="15" 
                                            icon="user"
                                            :src="itemU.avatar && itemU.avatar.path ? itemU.avatar.path : ''" />
                                    </div>
                                    {{checkNameList(itemU)}}
                                </div>
                            </a-tag>
