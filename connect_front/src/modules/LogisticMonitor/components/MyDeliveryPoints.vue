<template> 
    <a-drawer
        ...
        destroyOnClose
        @close="onClose">
        <div v-if="visible" class="points_wrap" :style="isMobile ? 'overflow-y: auto;' : 'display: flex;'">
...
export default {
    ...
    mounted () {
        ...
        eventBus.$on('show_position', coords => this.getCenter(coords))
        eventBus.$on('center_has_changed', coords => this.getCenter(coords))
    },
    beforeDestroy () {
