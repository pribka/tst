...
import VcPagination from 'ant-design-vue/es/vc-pagination';
import enUS from 'ant-design-vue/es/vc-pagination/locale/en_US';
    ...
    methods: {
        getIconsProps: function getIconsProps(prefixCls) {
            ...
            var prevIcon = h(
                ...
                [h('i', {
                    attrs: { type: 'left', class: 'fi fi-rr-angle-small-left' }
                })]
            );
            var nextIcon = h(
                'a',
                { 'class': prefixCls + '-item-link' },
                [h('i', {
                    attrs: { type: 'right', class: 'fi fi-rr-angle-small-right' }
                })]
            );
            var jumpPrevIcon = h(
                'a',
                ...
                [h(
                    ...
                    [h('i', { 'class': prefixCls + '-item-link-icon fi fi-rr-angle-double-small-left', attrs: { type: 'double-left' }
                    }), h(
                        'i',
                        { 'class': prefixCls + '-item-ellipsis fi fi-rr-menu-dots' }
                    )]
                )]
            );
            var jumpNextIcon = h(
                ...
                [h(
                    'div',
                    { 'class': prefixCls + '-item-container' },
                    [h('i', { 'class': prefixCls + '-item-link-icon fi fi-rr-angle-double-small-right', attrs: { type: 'double-right' }
                    }), h(
                        'i',
                        { 'class': prefixCls + '-item-ellipsis fi fi-rr-menu-dots' }
                    )]
