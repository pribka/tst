...
import { getOptionProps, getComponentFromProp, getListeners } from 'ant-design-vue/es/_util/props-util';
...
export default {
    ...
    methods: {
        ...
        renderSuffix: function renderSuffix(prefixCls) {
            ...
            var icon = h('i', { 'class': prefixCls + '-icon fi fi-rr-search', attrs: { type: 'search' },
                key: 'searchIcon', on: {
                    'click': this.onSearch
                }
            });
