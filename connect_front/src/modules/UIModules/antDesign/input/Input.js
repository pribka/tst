...
import { hasProp, getComponentFromProp, getListeners, getOptionProps } from 'ant-design-vue/es/_util/props-util';
...
export function getInputClassName(prefixCls, size, disabled, inputType, noXPadding) {
    var _classNames

    return classNames(
        prefixCls,
        (_classNames = {},
        _defineProperty(_classNames, prefixCls + '-sm', size === 'small'),
        _defineProperty(_classNames, prefixCls + '-lg', size === 'large'),
        _defineProperty(_classNames, prefixCls + '-disabled', disabled),
        _defineProperty(_classNames, prefixCls + '-ghost', inputType === 'ghost'),
        _defineProperty(_classNames, prefixCls + '-bg', inputType === 'bg'),
        _defineProperty(_classNames, prefixCls + '-x-pd', noXPadding),
        _classNames)
    )
}
...
export default {
    ...
    methods: {
        ...
        renderInput: function renderInput(prefixCls) {
            ...
            var otherProps = omit(this.$props, ['prefixCls', 'addonBefore', 'addonAfter', 'prefix', 'suffix', 'allowClear', 'value', 'defaultValue', 'lazy', 'size', 'inputType', 'className', 'noXPadding']);
            ...
            var inputProps = {
                ...
                'class': getInputClassName(prefixCls, size, disabled, inputType, noXPadding),
                ref: 'input',
                key: 'ant-input'
            };
    ...
    render: function render() {
        ...
        var noXPadding = getComponentFromProp(this, 'noXPadding');
        var props = {
            props: _extends({}, getOptionProps(this), {
                prefixCls: noXPadding ? `no-x-pd ${prefixCls}` : prefixCls,
                inputType: 'input',
                value: fixControlledValue(stateValue),
