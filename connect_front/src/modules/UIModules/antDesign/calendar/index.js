...
import { getOptionProps, hasProp, initDefaultProps, getListeners } from 'ant-design-vue/es/_util/props-util';
...
import { checkValidate, stringToMoment, momentToString, TimeType } from 'ant-design-vue/es/_util/moment-util';
...
var Calendar = {
    ...
    methods: {
        ...
        getDefaultLocale: function getDefaultLocale() {
            var result = _extends({}, ruRU, this.$props.locale);
