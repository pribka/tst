    ...
    return {
        ...
        render: function render() {
            ...
            var customizePrefixCls = props.prefixCls,
                ...
                iconPosition = props.iconPosition || 'default';
            ...
            var clearIcon = !props.disabled && props.allowClear && value ? h('i', {
                attrs: {
                    type: 'close-circle',

                    theme: 'filled'
                },
                'class': prefixCls + '-picker-clear fi-rr-cross-small',
                on: {
