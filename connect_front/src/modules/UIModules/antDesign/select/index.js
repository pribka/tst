...
import { getComponentFromProp, getOptionProps, filterEmpty, isValidElement, getListeners } from 'ant-design-vue/es/_util/props-util';
...
var Select = {
    ...
    methods: {
        getNotFoundContent: function getNotFoundContent() {
        ...
        renderSuffixIcon: function renderSuffixIcon(prefixCls) {
            ...
            return h('i', {
                attrs: { type: 'down' },
                'class': prefixCls + 'ant-select-arrow fi fi-rr-angle-small-down' });
        },
        renderPrefixIcon: function renderPrefixIcon(prefixCls) {
            var h = this.$createElement;
            var prefixIcon = getComponentFromProp(this, 'prefixIcon');
            prefixIcon = Array.isArray(prefixIcon) ? prefixIcon[0] : prefixIcon;
            if (prefixIcon) {
                return isValidElement(prefixIcon)
                    ? cloneElement(prefixIcon, { 'class': prefixCls + '-prefix-icon' })
                    : prefixIcon;
            }
            return null;
        }
    ...
    render: function render() {
        ...
        var _getOptionProps = getOptionProps(this),
            ...
            inputType = _getOptionProps.inputType,
            mode = _getOptionProps.mode,
            options = _getOptionProps.options,
            getPopupContainer = _getOptionProps.getPopupContainer,
            showArrow = _getOptionProps.showArrow,
            restProps = _objectWithoutProperties(_getOptionProps, ['prefixCls', 'size', 'mode', 'options', 'getPopupContainer', 'showArrow', 'inputType']);
        ...
        var rest = omit(restProps, ['inputIcon', 'removeIcon', 'clearIcon', 'suffixIcon', 'prefixIcon', 'menuItemSelectedIcon']);

        var cls = (_cls = {}, _defineProperty(_cls, prefixCls + '-lg', size === 'large'), _defineProperty(_cls, prefixCls + '-ghost', inputType === 'ghost'), _defineProperty(_cls, prefixCls + '-sm', size === 'small'), _defineProperty(_cls, prefixCls + '-show-arrow', showArrow), _cls);
        ...
        var selectProps = {
            props: _extends({
                ...
                inputPrefixIcon: this.renderPrefixIcon(prefixCls),
