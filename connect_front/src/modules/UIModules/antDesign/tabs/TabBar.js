...
import ScrollableInkTabBar from 'ant-design-vue/es/vc-tabs/src/ScrollableInkTabBar';
    ...
    render: function render() {
        ...
        var prevIcon = h(
            ...
            [h('i', {
                ...
                'class': prefixCls + '-tab-prev-icon-target fi fi-rr-angle-left' })]
        );
        var nextIcon = h(
            'span',
            ...
            [h('i', {
                ...
                'class': prefixCls + '-tab-next-icon-target fi fi-rr-angle-right' })]
        );
