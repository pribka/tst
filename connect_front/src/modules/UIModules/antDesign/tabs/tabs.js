...
import VcTabs, { TabPane } from 'ant-design-vue/es/vc-tabs/src';
import TabContent from 'ant-design-vue/es/vc-tabs/src/TabContent';
import { isFlexSupported } from 'ant-design-vue/es/_util/styleChecker';
import PropTypes from 'ant-design-vue/es/_util/vue-types';
import { getComponentFromProp, getOptionProps, filterEmpty, getListeners } from 'ant-design-vue/es/_util/props-util';
import { cloneElement } from 'ant-design-vue/es/_util/vnode';
import isValid from 'ant-design-vue/es/_util/isValid';
...
export default {
    ...
    props: {
        ...
        showBar: PropTypes.bool.def(true),
        showContent: PropTypes.bool.def(true)
    },
    inject: {
    ...
    render: function render() {
        ...
        var tabsProps = {
            props: _extends({}, getOptionProps(this), {
                ...
                renderTabBar: showBar ? function renderTabBar() {
                    return h(TabBar, _mergeJSXProps([{ key: 'tabBar' }, tabBarProps]));
                } : () => {},
                renderTabContent: showContent ? function renderTabContent() {
