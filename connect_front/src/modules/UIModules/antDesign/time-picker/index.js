...
import VcTimePicker from '@apps/UIModules/antDesign/vc-time-picker';
...
import { initDefaultProps, hasProp, getOptionProps, getComponentFromProp, isValidElement, getListeners } from 'ant-design-vue/es/_util/props-util';
...
import { checkValidate, stringToMoment, momentToString, TimeOrTimesType } from '@apps/UIModules/antDesign/moment-util.js';
...
var TimePicker = {
    ...
    methods: {
        ...
        getDefaultLocale: function getDefaultLocale() {
            var defaultLocale = _extends({}, ruRU, this.$props.locale);
        ...
        renderInputIcon: function renderInputIcon(prefixCls) {
            ...
            var clockIcon = suffixIcon && isValidElement(suffixIcon) && cloneElement(suffixIcon, {
                ...
                'class': prefixCls + '-clock-icon fi fi-rr-clock-three' });
        ...
        renderClearIcon: function renderClearIcon(prefixCls) {
            ...
            var clearIconPrefixCls = prefixCls + '-clear fi fi-rr-cross-small';
