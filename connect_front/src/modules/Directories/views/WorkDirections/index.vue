<template>
    <ModuleWrapper
        ...
        <WorkDirectionsListMobile
            v-else
            :pageModel="initPageModel"
            :pageName="initPageName" />
        <WorkDirectionFormModal :model="initPageModel" contractorSelect />
        <MobileFloatActions
            v-if="isMobile"
            :pageModel="initPageModel"
            :pageName="initPageName"
...
export default {
    components: {
        ...
        WorkDirectionFormModal: () => import('../../components/WorkDirectionFormModal.vue'),
        WorkDirectionsListMobile: () => import('./ListMobile.vue'),
    ...
    computed: {
        ...
        pageTitle() {
            return this.$route?.meta?.title || this.$t('directories.work_directions_label')
        },
    ...
    methods: {
        addHandler() {
            eventBus.$emit('open_modal_work_direction_add')
        },
        openCatalogMenu() {
