                    ...
                    <template v-if="value && value.length">
                        <a-tag 
                            ...
                            <div class="flex items-center">
                                {{ value[0].name || value[0].string_view }}
                            </div>
                        </a-tag>
...
export default {
    ...
    computed: {
        selectButtonText() {
            return this.$t('team.change')
            // return this.value?.length ? this.$t('team.change') : this.$t('team.select')
        },
        size() {
        ...
        async scrollHandler($state) {
            if(!this.isUserListLoading) {
                ...
                try {
                    ...
                    this.userList.push(...data.selectList)
                    if(data.next) {
                        this.page += 1 
                        $state.loaded()
                    } else {
