<template>
    <div class="border custom_border_color overflow-hidden rounded-lg">
        ...
        <transition
            ...
            @leave="leave">
            <div v-show="isExpand">
                <div class="p-4 custom_bg border-t custom_border_color">
                    <AccordionItemHeader 
                        class="mb-4"
                    ...
                    <template v-if="showDepartments">
                        <ul class="mt-4">
                            <div class="mb-3 flex justify-between items-center">
                                <p class="font-semibold ">{{ $t('team.internal_subdivisions') }}</p>
                            ...
                            <template v-else>
                                <div 
                                    class="custom_mb h-[40px] rounded-lg bg-gray-200"
                    ...
                    <template v-if="showChildren">
                        <ul class="mt-4">
                            <div class="mb-3 flex justify-between items-center">
                                <p class="font-semibold ">{{ $t('team.structural_subdivisions') }}</p>
                            ...
                            <template v-else>
                                <div 
                                    class="custom_mb h-[40px] rounded-lg bg-gray-100"
