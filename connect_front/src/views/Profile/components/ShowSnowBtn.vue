...
export default {
    computed: {
        active() {
            return this.$store.state.showSnow
        }
    },
    methods: {
        toggleSnow() {
            this.$store.commit('SNOW_TOGGLE')
        }
    }
}
</script>
