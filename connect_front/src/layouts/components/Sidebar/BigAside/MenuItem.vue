        ...
        <div 
            ...
            <div class="menu_item__right">
                ...
                <div v-if="item.badge && !disableNavigation" class="flex gap-2 items-center">
                    ...
                    <transition name="badge-pop">
                        <div v-if="getCounter && getCounter.mention_count" class="mentions_badge">
                            @
                            <a-badge 
